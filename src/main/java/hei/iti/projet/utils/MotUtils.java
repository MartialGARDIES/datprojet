...
public class MotUtils {
	// Algorithme de hash utilis̩
		...
		public static void main(String[] args) {
			try {
				System.out.println(String.format("Georges=%s", MotUtils.genererMotDePasse("Abitbol")));
				System.out.println(String.format("Emile=%s", MotUtils.genererMotDePasse("Odile")));
				System.out.println(String.format("Patout=%s", MotUtils.genererMotDePasse("Lugras")));
